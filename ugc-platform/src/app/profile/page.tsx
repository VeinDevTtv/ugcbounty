          ...
          <div className="space-y-6">
            {bounties.length === 0 ? (
              ...
              bounties.map((bounty) => (
                <div
                  key={bounty.id}
                  className="bg-white border border-black rounded-lg p-6 space-y-4"
                >
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-2 border border-zinc-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black min-h-[100px]"
                    ...
                    <>
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-zinc-700 mb-4">{bounty.description}</p>
                        </div>
                        <Button
                          variant="outline"
                          size="sm"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4 border-t border-zinc-200">
                        <div>
                          <p className="text-sm text-zinc-500 mb-1">Total Bounty</p>
                          <p className="text-lg font-bold text-zinc-900">
                            {formatCurrency(bounty.total_bounty)}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-zinc-500 mb-1">Rate per 1k Views</p>
                          <p className="text-lg font-bold text-zinc-900">
                            {formatCurrency(bounty.rate_per_1k_views)}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-zinc-500 mb-1">Claimed Bounty</p>
                          <p className="text-lg font-bold text-zinc-900">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-white border border-black rounded-lg p-4">
                <p className="text-sm text-zinc-500 mb-1">Total Earnings</p>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <Link
                          ...
                          className="text-xl font-bold text-zinc-900 hover:text-indigo-600 mb-2 block"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4 border-t border-zinc-200">
                      ...
                      <div>
                        <p className="text-sm text-zinc-500 mb-1">Potential Earnings</p>
                        <p className="text-lg font-bold text-zinc-900">
