...
export default function StatsWidget({ label, value, icon: Icon, trend }: Props) {
    return (
        <div className="rounded-2xl border border-[#1F2933] bg-[#111827] p-6 shadow-[0_12px_30px_rgba(15,23,42,0.6)]">
            ...
            <div className="flex items-end gap-2">
                ...
                {trend && <span className="text-xs text-[#22C55E] mb-1 font-medium">{trend}</span>}
            </div>
        </div>
    );
}
